...
// console.log(
//   `Hello my name is ${name.toUpperCase()} and my repo count is ${repoCount}` //new version, string interpolation / Template Literals / back-tick used karane ka fayada , yaha pe aata hai string interpolation hai kya aap banate hai place holder unake andar jo bhi variable directely inject kara sakate hai
// );

const gameName = new String("Ajit-hc-com"); //string declaration karane ka second way using "Constructor"
